...
public class CrearCliente extends javax.swing.JFrame {
    ...
    public CrearCliente() {
        initComponents();
        String ids[] = {"ID Cliente", "Cedula", "Nombre", "Apellido"};
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ObjCliente.setCedula(Integer.parseInt(jTextField1.getText()));
        ObjCliente.setNombres(jTextField2.getText());
        ObjCliente.setApellidos(jTextField3.getText());

        try {
            Controller.create(ObjCliente);
            emf.getCache().evictAll();

            mt.addRow(new Object[]{
                ObjCliente.getIdClie(),
            ...
            Logger.getLogger(CrearCliente.class.getName()).log(
